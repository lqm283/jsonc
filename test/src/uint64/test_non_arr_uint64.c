 ...
 * @LastEditTime : 2023-03-22 14:10:06
 * @LastEditors  : lqm283
 * --------------------------------------------------------------------------------<
 * @Description  : Please edit a descrition about this file at here.
 * --------------------------------------------------------------------------------<
 * @FilePath     : /jsonc/test/src/uint64/test_non_arr_uint64.c
 */
...
#include "../../include/uint64/test_non_arr_uint64.h"
/*
----------------------------------------------
复合类型转换为 json
----------------------------------------------
...
int test_change_non_arr_mult_uint64_num_to_json(char* exp, char* real) {
    ...
    struct TestNonArrMultUint64Num num = {{128, 255, 0, 1, 127},
                                          {128, 255, 0, 1, 127},
                                          {128, 255, 0, 1, 127},
                                          {128, 255, 0, 1, 127},
                                          {128, 255, 0, 1, 127}};
...
int test_change_non_arr_mult_uint64_bool_to_json(char* exp, char* real) {
    ...
    struct TestNonArrMultUint64Bool bool = {{128, 255, 0, 1, 127},
                                            {128, 255, 0, 1, 127},
                                            {128, 255, 0, 1, 127},
                                            {128, 255, 0, 1, 127},
                                            {128, 255, 0, 1, 127}};
...
int test_change_single_str_json_to_non_arr_single_uint64_num(char* json) {
    int ret = 0;
    struct TestNonArrSingleUint64Num num;
    ret = JsoncDeserialize(json, &num, TestNonArrSingleUint64Num);
    if (ret) {
        return ret;
    }
    if (*num.num != 10) {
...
int test_change_mult_str_json_to_non_arr_single_uint64_num(char* json) {
    return test_change_single_str_json_to_non_arr_single_uint64_num(json);
}
...
int test_change_mult_bool_json_to_non_arr_single_uint64_num(char* json) {
    return test_change_single_bool_json_to_non_arr_single_uint64_num(json);
}
...
int test_change_mult_null_json_to_non_arr_single_uint64_num(char* json) {
    return test_change_single_null_json_to_non_arr_single_uint64_num(json);
}

// 单元素 Str 类型的 json 转换为保存 Bool 类型的单成员 char
int test_change_single_str_json_to_non_arr_single_uint64_bool(char* json) {
    int ret = 0;
    struct TestNonArrSingleUint64Bool b;
    ret = JsoncDeserialize(json, &b, TestNonArrSingleUint64Bool);
    if (ret) {
        return ret;
    }
    if (*b.b != 1) {
...
int test_change_mult_str_json_to_non_arr_single_uint64_bool(char* json) {
    return test_change_single_str_json_to_non_arr_single_uint64_bool(json);
}
...
int test_change_mult_null_json_to_non_arr_single_uint64_bool(char* json) {
    return test_change_single_null_json_to_non_arr_single_uint64_bool(json);
}

// 完全匹配的多元素 Str 类型的 json 转换为保存 Num 类型的多成员 char
int test_change_equal_mult_str_json_to_non_arr_mult_uint64_num(char* json) {
    int ret = 0;
    struct TestNonArrMultUint64Num num;
    ret = JsoncDeserialize(json, &num, TestNonArrMultUint64Num);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_non_arr_mult_uint64_num(char* json) {
    return test_change_equal_mult_str_json_to_non_arr_mult_uint64_num(json);
}
...
int test_change_diff_mult_str_json_to_non_arr_mult_uint64_num(char* json) {
    return test_change_less_mult_str_json_to_non_arr_mult_uint64_num(json);
}
...
int test_change_more_mult_bool_json_to_non_arr_mult_uint64_num(char* json) {
    return test_change_equal_mult_bool_json_to_non_arr_mult_uint64_num(json);
}
...
int test_change_diff_mult_bool_json_to_non_arr_mult_uint64_num(char* json) {
    return test_change_less_mult_bool_json_to_non_arr_mult_uint64_num(json);
}
...
int test_change_more_mult_null_json_to_non_arr_mult_uint64_num(char* json) {
    return test_change_equal_mult_null_json_to_non_arr_mult_uint64_num(json);
}
...
int test_change_diff_mult_null_json_to_non_arr_mult_uint64_num(char* json) {
    return test_change_less_mult_null_json_to_non_arr_mult_uint64_num(json);
}

// 完全匹配的多元素 Str 类型的 json 转换为保存 Num 类型的多成员 char
int test_change_equal_mult_str_json_to_non_arr_mult_uint64_bool(char* json) {
    int ret = 0;
    struct TestNonArrMultUint64Bool bool;
    ret = JsoncDeserialize(json, &bool, TestNonArrMultUint64Bool);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_non_arr_mult_uint64_bool(char* json) {
    return test_change_equal_mult_str_json_to_non_arr_mult_uint64_bool(json);
}
...
int test_change_diff_mult_str_json_to_non_arr_mult_uint64_bool(char* json) {
    return test_change_less_mult_str_json_to_non_arr_mult_uint64_bool(json);
}
...
int test_change_more_mult_bool_json_to_non_arr_mult_uint64_bool(char* json) {
    return test_change_equal_mult_bool_json_to_non_arr_mult_uint64_bool(json);
}
...
int test_change_diff_mult_bool_json_to_non_arr_mult_uint64_bool(char* json) {
    return test_change_less_mult_bool_json_to_non_arr_mult_uint64_bool(json);
}
...
int test_change_more_mult_null_json_to_non_arr_mult_uint64_bool(char* json) {
    return test_change_equal_mult_null_json_to_non_arr_mult_uint64_bool(json);
}
...
int test_change_diff_mult_null_json_to_non_arr_mult_uint64_bool(char* json) {
    return test_change_less_mult_null_json_to_non_arr_mult_uint64_bool(json);
}
