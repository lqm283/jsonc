 ...
 * @LastEditTime : 2023-03-22 14:12:47
 * @LastEditors  : lqm283
 * --------------------------------------------------------------------------------<
 * @Description  : Please edit a descrition about this file at here.
 * --------------------------------------------------------------------------------<
 * @FilePath     : /jsonc/test/src/uint64/test_ptr_arr_uint64.c
 */
...
#include "../../include/uint64/test_ptr_arr_uint64.h"
/*
----------------------------------------------
复合类型转换为 json
----------------------------------------------
...
int test_change_ptr_arr_single_uint64_str_to_json(char* exp, char* real) {
    int ret = 0;
    char* e =
        "{\"str\":[\"test change char * [0] str to json\",\"test change char * [1] str "
        "to json\"]}";
    struct TestPtrArrSingleUint64Str str = {
...
int test_change_ptr_arr_single_uint64_num_to_json(char* exp, char* real) {
    int ret = 0;
    char* e = "{\"num\":[10,20]}";
    struct TestPtrArrSingleUint64Num num;
    uint64_t num1 = 10;
    num.num[0] = &num1;
    num.num[1] = malloc(1);
    *num.num[1] = 20;
...
int test_change_ptr_arr_single_uint64_bool_to_json(char* exp, char* real) {
    int ret = 0;
    char* e = "{\"b\":[true,false]}";
    uint64_t bool1 = 1;
    uint64_t bool2 = 0;
...
int test_change_ptr_arr_mult_uint64_str_to_json(char* exp, char* real) {
    int ret = 0;
    char* e =
        "{\"str1\":[\"str1_0\",\"str1_1\"],\"str2\":[\"str2_0\",\"str2_1\"],\"str3\":["
        "\"str3_0\",\"str3_1\"]}";
    struct TestPtrArrMultUint64Str str = {{(uint64_t*)"str1_0", (uint64_t*)"str1_1"},
...
int test_change_ptr_arr_mult_uint64_num_to_json(char* exp, char* real) {
    int ret = 0;
...
int test_change_ptr_arr_mult_uint64_bool_to_json(char* exp, char* real) {
    int ret = 0;
    ...
    uint64_t bool5 = 0;
    uint64_t bool6 = 1;
    struct TestPtrArrMultUint64Bool bool = {{&bool1, &bool2},
                                            {&bool3, &bool4},
                                            {&bool5, &bool6}};
...
int test_change_single_str_json_to_ptr_arr_single_uint64_num(char* json) {
    int ret = 0;
    struct TestPtrArrSingleUint64Num num;
    num.num[0] = malloc(sizeof(uint64_t));
    num.num[1] = malloc(sizeof(uint64_t));
    ret = JsoncDeserialize(json, &num, TestPtrArrSingleUint64Num);
    if (ret) {
        return ret;
    }
...
int test_change_mult_str_json_to_ptr_arr_single_uint64_num(char* json) {
    return test_change_single_str_json_to_ptr_arr_single_uint64_num(json);
}
...
int test_change_mult_bool_json_to_ptr_arr_single_uint64_num(char* json) {
    return test_change_single_bool_json_to_ptr_arr_single_uint64_num(json);
}
...
int test_change_mult_null_json_to_ptr_arr_single_uint64_num(char* json) {
    return test_change_single_null_json_to_ptr_arr_single_uint64_num(json);
}

// 单元素 Str 类型的 json 转换为保存 Bool 类型的指针数组单成员 char
int test_change_single_str_json_to_ptr_arr_single_uint64_bool(char* json) {
    int ret = 0;
    struct TestPtrArrSingleUint64Bool b;
    b.b[0] = malloc(sizeof(uint64_t));
    b.b[1] = malloc(sizeof(uint64_t));
    ret = JsoncDeserialize(json, &b, TestPtrArrSingleUint64Bool);
    if (ret) {
        return ret;
    }
    if (*b.b[0] != 1 || *b.b[1] != 0) {
...
int test_change_mult_str_json_to_ptr_arr_single_uint64_bool(char* json) {
    return test_change_single_str_json_to_ptr_arr_single_uint64_bool(json);
}
...
int test_change_mult_null_json_to_ptr_arr_single_uint64_bool(char* json) {
    return test_change_single_null_json_to_ptr_arr_single_uint64_bool(json);
}

// 完全匹配的多元素 Str 类型的 json 转换为保存 Num 类型的指针数组多成员 char
int test_change_equal_mult_str_json_to_ptr_arr_mult_uint64_num(char* json) {
    int ret = 0;
    struct TestPtrArrMultUint64Num num;
    num.num1[0] = malloc(sizeof(uint64_t));
    num.num1[1] = malloc(sizeof(uint64_t));
    num.num2[0] = malloc(sizeof(uint64_t));
    num.num2[1] = malloc(sizeof(uint64_t));
    num.num3[0] = malloc(sizeof(uint64_t));
    num.num3[1] = malloc(sizeof(uint64_t));
    ret = JsoncDeserialize(json, &num, TestPtrArrMultUint64Num);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_ptr_arr_mult_uint64_num(char* json) {
    return test_change_equal_mult_str_json_to_ptr_arr_mult_uint64_num(json);
}
...
int test_change_diff_mult_str_json_to_ptr_arr_mult_uint64_num(char* json) {
    return test_change_less_mult_str_json_to_ptr_arr_mult_uint64_num(json);
}
...
int test_change_more_mult_bool_json_to_ptr_arr_mult_uint64_num(char* json) {
    return test_change_equal_mult_bool_json_to_ptr_arr_mult_uint64_num(json);
}
...
int test_change_diff_mult_bool_json_to_ptr_arr_mult_uint64_num(char* json) {
    return test_change_less_mult_bool_json_to_ptr_arr_mult_uint64_num(json);
}
...
int test_change_more_mult_null_json_to_ptr_arr_mult_uint64_num(char* json) {
    return test_change_equal_mult_null_json_to_ptr_arr_mult_uint64_num(json);
}
...
int test_change_diff_mult_null_json_to_ptr_arr_mult_uint64_num(char* json) {
    return test_change_less_mult_null_json_to_ptr_arr_mult_uint64_num(json);
}

// 完全匹配的多元素 Str 类型的 json 转换为保存 Bool 类型的多成员 char
int test_change_equal_mult_str_json_to_ptr_arr_mult_uint64_bool(char* json) {
    int ret = 0;
    struct TestPtrArrMultUint64Bool bool;
    bool.bool1[0] = malloc(sizeof(uint64_t));
    bool.bool1[1] = malloc(sizeof(uint64_t));
    bool.bool2[0] = malloc(sizeof(uint64_t));
    bool.bool2[1] = malloc(sizeof(uint64_t));
    bool.bool3[0] = malloc(sizeof(uint64_t));
    bool.bool3[1] = malloc(sizeof(uint64_t));
    ret = JsoncDeserialize(json, &bool, TestPtrArrMultUint64Bool);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_ptr_arr_mult_uint64_bool(char* json) {
    return test_change_equal_mult_str_json_to_ptr_arr_mult_uint64_bool(json);
}
...
int test_change_diff_mult_str_json_to_ptr_arr_mult_uint64_bool(char* json) {
    return test_change_less_mult_str_json_to_ptr_arr_mult_uint64_bool(json);
}
...
int test_change_more_mult_bool_json_to_ptr_arr_mult_uint64_bool(char* json) {
    return test_change_equal_mult_bool_json_to_ptr_arr_mult_uint64_bool(json);
}
...
int test_change_diff_mult_bool_json_to_ptr_arr_mult_uint64_bool(char* json) {
    return test_change_less_mult_bool_json_to_ptr_arr_mult_uint64_bool(json);
}
...
int test_change_more_mult_null_json_to_ptr_arr_mult_uint64_bool(char* json) {
    return test_change_equal_mult_null_json_to_ptr_arr_mult_uint64_bool(json);
}
...
int test_change_diff_mult_null_json_to_ptr_arr_mult_uint64_bool(char* json) {
    return test_change_less_mult_null_json_to_ptr_arr_mult_uint64_bool(json);
}
