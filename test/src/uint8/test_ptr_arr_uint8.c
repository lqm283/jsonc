 ...
 * --------------------------------------------------------------------------------<
 * @FilePath     : /jsonc/test/src/uint8/test_ptr_arr_uint8.c
 */

#include "../../include/uint8/test_ptr_arr_uint8.h"
...
char* test_change_ptr_arr_single_uint8_str_to_json(char* exp, char* real) {
    char* ret = 0;
    char* e =
        "{\"str\":[\"test change char * [0] str to json\",\"test change char * [1] str "
        "to json\"]}";
    struct TestPtrArrSingleUint8Str str = {
        {(uint8_t*)"test change char * [0] str to json",
         (uint8_t*)"test change char * [1] str to json"}};
    ret = JsoncSerialize(real, &str, TestPtrArrSingleUint8Str);
    if (ret) {
        strcpy(exp, e);
    }
    return ret;
...
char* test_change_ptr_arr_single_uint8_num_to_json(char* exp, char* real) {
    char* ret = 0;
    char* e = "{\"num\":[10,20]}";
    struct TestPtrArrSingleUint8Num num;
    uint8_t num1 = 10;
    num.num[0] = &num1;
    num.num[1] = malloc(1);
    *num.num[1] = 20;
    ret = JsoncSerialize(real, &num, TestPtrArrSingleUint8Num);
    if (ret) {
        strcpy(exp, e);
    }
    return ret;
...
char* test_change_ptr_arr_single_uint8_bool_to_json(char* exp, char* real) {
    char* ret = 0;
    char* e = "{\"b\":[true,false]}";
    uint8_t bool1 = 1;
    uint8_t bool2 = 0;
    struct TestPtrArrSingleUint8Bool b = {{&bool1, &bool2}};
    ret = JsoncSerialize(real, &b, TestPtrArrSingleUint8Bool);
    if (ret) {
        strcpy(exp, e);
    }
    return ret;
...
char* test_change_ptr_arr_mult_uint8_str_to_json(char* exp, char* real) {
    char* ret = 0;
    char* e =
        "{\"str1\":[\"str1_0\",\"str1_1\"],\"str2\":[\"str2_0\",\"str2_1\"],\"str3\":["
        "\"str3_0\",\"str3_1\"]}";
    struct TestPtrArrMultUint8Str str = {{(uint8_t*)"str1_0", (uint8_t*)"str1_1"},
                                         {(uint8_t*)"str2_0", (uint8_t*)"str2_1"},
                                         {(uint8_t*)"str3_0", (uint8_t*)"str3_1"}};
    ret = JsoncSerialize(real, &str, TestPtrArrMultUint8Str);
    if (ret) {
        strcpy(exp, e);
    }
    return ret;
...
char* test_change_ptr_arr_mult_uint8_num_to_json(char* exp, char* real) {
    char* ret = 0;
    ...
    struct TestPtrArrMultUint8Num num = {{&num1, &num2}, {&num3, &num4}, {&num5, &num6}};
    ret = JsoncSerialize(real, &num, TestPtrArrMultUint8Num);
    if (ret) {
        strcpy(exp, e);
    }
    return ret;
...
char* test_change_ptr_arr_mult_uint8_bool_to_json(char* exp, char* real) {
    char* ret = 0;
    ...
    uint8_t bool5 = 0;
    uint8_t bool6 = 1;
    struct TestPtrArrMultUint8Bool bool = {{&bool1, &bool2},
                                           {&bool3, &bool4},
                                           {&bool5, &bool6}};
    ret = JsoncSerialize(real, &bool, TestPtrArrMultUint8Bool);
    if (ret) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_single_str_json_to_ptr_arr_single_uint8_str(char* json) {
    int ret = 0;
    struct TestPtrArrSingleUint8Str str;
    str.str[0] = malloc(100 * sizeof(uint8_t));
    str.str[1] = malloc(100 * sizeof(uint8_t));
    ret = JsoncDeserialize(json, &str, TestPtrArrSingleUint8Str);
    if (ret) {
        return ret;
    }
...
int test_change_mult_str_json_to_ptr_arr_single_uint8_str(char* json) {
    return test_change_single_str_json_to_ptr_arr_single_uint8_str(json);
}
...
int test_change_single_num_json_to_ptr_arr_single_uint8_str(char* json) {
    int ret = 0;
    struct TestPtrArrSingleUint8Str str;
    str.str[0] = malloc(sizeof(uint8_t) * 20);
    str.str[1] = malloc(sizeof(uint8_t) * 20);
    ret = JsoncDeserialize(json, &str, TestPtrArrSingleUint8Str);
    if (ret) {
        return ret;
    }
...
int test_change_mult_num_json_to_ptr_arr_single_uint8_str(char* json) {
    return test_change_single_num_json_to_ptr_arr_single_uint8_str(json);
}
...
int test_change_mult_bool_json_to_ptr_arr_single_uint8_str(char* json) {
    return test_change_single_bool_json_to_ptr_arr_single_uint8_str(json);
}
...
int test_change_mult_null_json_to_ptr_arr_single_uint8_str(char* json) {
    return test_change_single_null_json_to_ptr_arr_single_uint8_str(json);
}
...
int test_change_single_str_json_to_ptr_arr_single_uint8_num(char* json) {
    int ret = 0;
    struct TestPtrArrSingleUint8Num num;
    num.num[0] = malloc(sizeof(uint8_t));
    num.num[1] = malloc(sizeof(uint8_t));
    ret = JsoncDeserialize(json, &num, TestPtrArrSingleUint8Num);
    if (ret) {
        return ret;
    }
...
int test_change_mult_str_json_to_ptr_arr_single_uint8_num(char* json) {
    return test_change_single_str_json_to_ptr_arr_single_uint8_num(json);
}
...
int test_change_mult_bool_json_to_ptr_arr_single_uint8_num(char* json) {
    return test_change_single_bool_json_to_ptr_arr_single_uint8_num(json);
}
...
int test_change_mult_null_json_to_ptr_arr_single_uint8_num(char* json) {
    return test_change_single_null_json_to_ptr_arr_single_uint8_num(json);
}

// 单元素 Str 类型的 json 转换为保存 Bool 类型的指针数组单成员 char
int test_change_single_str_json_to_ptr_arr_single_uint8_bool(char* json) {
    int ret = 0;
    struct TestPtrArrSingleUint8Bool b;
    b.b[0] = malloc(sizeof(uint8_t));
    b.b[1] = malloc(sizeof(uint8_t));
    ret = JsoncDeserialize(json, &b, TestPtrArrSingleUint8Bool);
    if (ret) {
        return ret;
    }
    if (*b.b[0] != 1 || *b.b[1] != 0) {
...
int test_change_mult_str_json_to_ptr_arr_single_uint8_bool(char* json) {
    return test_change_single_str_json_to_ptr_arr_single_uint8_bool(json);
}
...
int test_change_mult_null_json_to_ptr_arr_single_uint8_bool(char* json) {
    return test_change_single_null_json_to_ptr_arr_single_uint8_bool(json);
}

// 完全匹配的多元素 Str 类型的 json 转换为保存 Str 类型的指针数组多成员 char
int test_change_equal_mult_str_json_to_ptr_arr_mult_uint8_str(char* json) {
    int ret = 0;
    struct TestPtrArrMultUint8Str str;
    str.str1[0] = malloc(100 * sizeof(uint8_t));
    str.str1[1] = malloc(100 * sizeof(uint8_t));
    str.str2[0] = malloc(100 * sizeof(uint8_t));
    str.str2[1] = malloc(100 * sizeof(uint8_t));
    str.str3[0] = malloc(100 * sizeof(uint8_t));
    str.str3[1] = malloc(100 * sizeof(uint8_t));
    ret = JsoncDeserialize(json, &str, TestPtrArrMultUint8Str);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_ptr_arr_mult_uint8_str(char* json) {
    return test_change_equal_mult_str_json_to_ptr_arr_mult_uint8_str(json);
}
...
int test_change_diff_mult_str_json_to_ptr_arr_mult_uint8_str(char* json) {
    return test_change_less_mult_str_json_to_ptr_arr_mult_uint8_str(json);
}
...
int test_change_more_mult_num_json_to_ptr_arr_mult_uint8_str(char* json) {
    return test_change_equal_mult_num_json_to_ptr_arr_mult_uint8_str(json);
}
...
int test_change_diff_mult_num_json_to_ptr_arr_mult_uint8_str(char* json) {
    return test_change_less_mult_num_json_to_ptr_arr_mult_uint8_str(json);
}
...
int test_change_more_mult_bool_json_to_ptr_arr_mult_uint8_str(char* json) {
    return test_change_equal_mult_bool_json_to_ptr_arr_mult_uint8_str(json);
}
...
int test_change_diff_mult_bool_json_to_ptr_arr_mult_uint8_str(char* json) {
    return test_change_less_mult_bool_json_to_ptr_arr_mult_uint8_str(json);
}
...
int test_change_more_mult_null_json_to_ptr_arr_mult_uint8_str(char* json) {
    return test_change_equal_mult_null_json_to_ptr_arr_mult_uint8_str(json);
}
...
int test_change_diff_mult_null_json_to_ptr_arr_mult_uint8_str(char* json) {
    return test_change_less_mult_null_json_to_ptr_arr_mult_uint8_str(json);
}

// 完全匹配的多元素 Str 类型的 json 转换为保存 Num 类型的指针数组多成员 char
int test_change_equal_mult_str_json_to_ptr_arr_mult_uint8_num(char* json) {
    int ret = 0;
    struct TestPtrArrMultUint8Num num;
    num.num1[0] = malloc(sizeof(uint8_t));
    num.num1[1] = malloc(sizeof(uint8_t));
    num.num2[0] = malloc(sizeof(uint8_t));
    num.num2[1] = malloc(sizeof(uint8_t));
    num.num3[0] = malloc(sizeof(uint8_t));
    num.num3[1] = malloc(sizeof(uint8_t));
    ret = JsoncDeserialize(json, &num, TestPtrArrMultUint8Num);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_ptr_arr_mult_uint8_num(char* json) {
    return test_change_equal_mult_str_json_to_ptr_arr_mult_uint8_num(json);
}
...
int test_change_diff_mult_str_json_to_ptr_arr_mult_uint8_num(char* json) {
    return test_change_less_mult_str_json_to_ptr_arr_mult_uint8_num(json);
}
...
int test_change_more_mult_bool_json_to_ptr_arr_mult_uint8_num(char* json) {
    return test_change_equal_mult_bool_json_to_ptr_arr_mult_uint8_num(json);
}
...
int test_change_diff_mult_bool_json_to_ptr_arr_mult_uint8_num(char* json) {
    return test_change_less_mult_bool_json_to_ptr_arr_mult_uint8_num(json);
}
...
int test_change_more_mult_null_json_to_ptr_arr_mult_uint8_num(char* json) {
    return test_change_equal_mult_null_json_to_ptr_arr_mult_uint8_num(json);
}
...
int test_change_diff_mult_null_json_to_ptr_arr_mult_uint8_num(char* json) {
    return test_change_less_mult_null_json_to_ptr_arr_mult_uint8_num(json);
}

// 完全匹配的多元素 Str 类型的 json 转换为保存 Bool 类型的多成员 char
int test_change_equal_mult_str_json_to_ptr_arr_mult_uint8_bool(char* json) {
    int ret = 0;
    struct TestPtrArrMultUint8Bool bool;
    bool.bool1[0] = malloc(sizeof(uint8_t));
    bool.bool1[1] = malloc(sizeof(uint8_t));
    bool.bool2[0] = malloc(sizeof(uint8_t));
    bool.bool2[1] = malloc(sizeof(uint8_t));
    bool.bool3[0] = malloc(sizeof(uint8_t));
    bool.bool3[1] = malloc(sizeof(uint8_t));
    ret = JsoncDeserialize(json, &bool, TestPtrArrMultUint8Bool);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_ptr_arr_mult_uint8_bool(char* json) {
    return test_change_equal_mult_str_json_to_ptr_arr_mult_uint8_bool(json);
}
...
int test_change_diff_mult_str_json_to_ptr_arr_mult_uint8_bool(char* json) {
    return test_change_less_mult_str_json_to_ptr_arr_mult_uint8_bool(json);
}
...
int test_change_more_mult_bool_json_to_ptr_arr_mult_uint8_bool(char* json) {
    return test_change_equal_mult_bool_json_to_ptr_arr_mult_uint8_bool(json);
}
...
int test_change_diff_mult_bool_json_to_ptr_arr_mult_uint8_bool(char* json) {
    return test_change_less_mult_bool_json_to_ptr_arr_mult_uint8_bool(json);
}
...
int test_change_more_mult_null_json_to_ptr_arr_mult_uint8_bool(char* json) {
    return test_change_equal_mult_null_json_to_ptr_arr_mult_uint8_bool(json);
}
...
int test_change_diff_mult_null_json_to_ptr_arr_mult_uint8_bool(char* json) {
    return test_change_less_mult_null_json_to_ptr_arr_mult_uint8_bool(json);
}
