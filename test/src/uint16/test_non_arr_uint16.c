 ...
 * --------------------------------------------------------------------------------<
 * @FilePath     : /jsonc/test/src/uint16/test_non_arr_uint16.c
 */

#include "../../include/uint16/test_non_arr_uint16.h"
...
char* test_change_non_arr_single_uint16_num_to_json(char* exp, char* real) {
    char* ret = 0;
    char* e = "{\"num\":[1,2,3,4,5]}";
    struct TestNonArrSingleUint16Num num = {{1, 2, 3, 4, 5}};
    ret = JsoncSerialize(real, &num, TestNonArrSingleUint16Num);
    if (ret) {
        strcpy(exp, e);
    }
    return ret;
...
char* test_change_non_arr_single_uint16_bool_to_json(char* exp, char* real) {
    char* ret = 0;
    char* e = "{\"b\":[true,false,true,true,false]}";
    struct TestNonArrSingleUint16Bool b = {{1, 0, 1, 1, 0}};
    ret = JsoncSerialize(real, &b, TestNonArrSingleUint16Bool);
    if (ret) {
        strcpy(exp, e);
    }
    return ret;
...
char* test_change_non_arr_mult_uint16_num_to_json(char* exp, char* real) {
    char* ret = 0;
    char* e =
        "{\"num1\":[128,255,0,1,127],\"num2\":[128,255,0,1,127],\"num3\":[128,255,0,1,"
        "127],\"num4\":[128,255,0,1,127],\"num5\":[128,255,0,1,127]}";
    struct TestNonArrMultUint16Num num = {{128, 255, 0, 1, 127},
                                          {128, 255, 0, 1, 127},
                                          {128, 255, 0, 1, 127},
                                          {128, 255, 0, 1, 127},
                                          {128, 255, 0, 1, 127}};
    ret = JsoncSerialize(real, &num, TestNonArrMultUint16Num);
    if (ret) {
        strcpy(exp, e);
    }
    return ret;
...
char* test_change_non_arr_mult_uint16_bool_to_json(char* exp, char* real) {
    char* ret = 0;
    char* e =
    ...
    struct TestNonArrMultUint16Bool bool = {{128, 255, 0, 1, 127},
                                            {128, 255, 0, 1, 127},
                                            {128, 255, 0, 1, 127},
                                            {128, 255, 0, 1, 127},
                                            {128, 255, 0, 1, 127}};
    ret = JsoncSerialize(real, &bool, TestNonArrMultUint16Bool);
    if (ret) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_single_str_json_to_non_arr_single_uint16_num(char* json) {
    int ret = 0;
    struct TestNonArrSingleUint16Num num;
    ret = JsoncDeserialize(json, &num, TestNonArrSingleUint16Num);
    if (ret) {
        return ret;
    }
    if (*num.num != 10) {
...
int test_change_mult_str_json_to_non_arr_single_uint16_num(char* json) {
    return test_change_single_str_json_to_non_arr_single_uint16_num(json);
}
...
int test_change_mult_bool_json_to_non_arr_single_uint16_num(char* json) {
    return test_change_single_bool_json_to_non_arr_single_uint16_num(json);
}
...
int test_change_mult_null_json_to_non_arr_single_uint16_num(char* json) {
    return test_change_single_null_json_to_non_arr_single_uint16_num(json);
}

// 单元素 Str 类型的 json 转换为保存 Bool 类型的单成员 char
int test_change_single_str_json_to_non_arr_single_uint16_bool(char* json) {
    int ret = 0;
    struct TestNonArrSingleUint16Bool b;
    ret = JsoncDeserialize(json, &b, TestNonArrSingleUint16Bool);
    if (ret) {
        return ret;
    }
    if (*b.b != 1) {
...
int test_change_mult_str_json_to_non_arr_single_uint16_bool(char* json) {
    return test_change_single_str_json_to_non_arr_single_uint16_bool(json);
}
...
int test_change_mult_null_json_to_non_arr_single_uint16_bool(char* json) {
    return test_change_single_null_json_to_non_arr_single_uint16_bool(json);
}

// 完全匹配的多元素 Str 类型的 json 转换为保存 Num 类型的多成员 char
int test_change_equal_mult_str_json_to_non_arr_mult_uint16_num(char* json) {
    int ret = 0;
    struct TestNonArrMultUint16Num num;
    ret = JsoncDeserialize(json, &num, TestNonArrMultUint16Num);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_non_arr_mult_uint16_num(char* json) {
    return test_change_equal_mult_str_json_to_non_arr_mult_uint16_num(json);
}
...
int test_change_diff_mult_str_json_to_non_arr_mult_uint16_num(char* json) {
    return test_change_less_mult_str_json_to_non_arr_mult_uint16_num(json);
}
...
int test_change_more_mult_bool_json_to_non_arr_mult_uint16_num(char* json) {
    return test_change_equal_mult_bool_json_to_non_arr_mult_uint16_num(json);
}
...
int test_change_diff_mult_bool_json_to_non_arr_mult_uint16_num(char* json) {
    return test_change_less_mult_bool_json_to_non_arr_mult_uint16_num(json);
}
...
int test_change_more_mult_null_json_to_non_arr_mult_uint16_num(char* json) {
    return test_change_equal_mult_null_json_to_non_arr_mult_uint16_num(json);
}
...
int test_change_diff_mult_null_json_to_non_arr_mult_uint16_num(char* json) {
    return test_change_less_mult_null_json_to_non_arr_mult_uint16_num(json);
}

// 完全匹配的多元素 Str 类型的 json 转换为保存 Num 类型的多成员 char
int test_change_equal_mult_str_json_to_non_arr_mult_uint16_bool(char* json) {
    int ret = 0;
    struct TestNonArrMultUint16Bool bool;
    ret = JsoncDeserialize(json, &bool, TestNonArrMultUint16Bool);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_non_arr_mult_uint16_bool(char* json) {
    return test_change_equal_mult_str_json_to_non_arr_mult_uint16_bool(json);
}
...
int test_change_diff_mult_str_json_to_non_arr_mult_uint16_bool(char* json) {
    return test_change_less_mult_str_json_to_non_arr_mult_uint16_bool(json);
}
...
int test_change_more_mult_bool_json_to_non_arr_mult_uint16_bool(char* json) {
    return test_change_equal_mult_bool_json_to_non_arr_mult_uint16_bool(json);
}
...
int test_change_diff_mult_bool_json_to_non_arr_mult_uint16_bool(char* json) {
    return test_change_less_mult_bool_json_to_non_arr_mult_uint16_bool(json);
}
...
int test_change_more_mult_null_json_to_non_arr_mult_uint16_bool(char* json) {
    return test_change_equal_mult_null_json_to_non_arr_mult_uint16_bool(json);
}
...
int test_change_diff_mult_null_json_to_non_arr_mult_uint16_bool(char* json) {
    return test_change_less_mult_null_json_to_non_arr_mult_uint16_bool(json);
}
