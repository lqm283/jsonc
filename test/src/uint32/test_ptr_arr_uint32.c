 ...
 * @LastEditTime : 2023-01-11 10:23:08
 * @LastEditors  : lqm283
 * --------------------------------------------------------------------------------<
...
char* test_change_ptr_arr_single_uint32_str_to_json(char* exp, char* real) {
    char* ret = 0;
    char* e =
...
char* test_change_ptr_arr_single_uint32_num_to_json(char* exp, char* real) {
    char* ret = 0;
    char* e = "{\"num\":[10,20]}";
...
char* test_change_ptr_arr_single_uint32_bool_to_json(char* exp, char* real) {
    char* ret = 0;
    char* e = "{\"b\":[true,false]}";
    uint32_t bool1 = 1;
    uint32_t bool2 = 0;
...
char* test_change_ptr_arr_mult_uint32_str_to_json(char* exp, char* real) {
    char* ret = 0;
    char* e =
...
char* test_change_ptr_arr_mult_uint32_num_to_json(char* exp, char* real) {
    char* ret = 0;
...
char* test_change_ptr_arr_mult_uint32_bool_to_json(char* exp, char* real) {
    char* ret = 0;
