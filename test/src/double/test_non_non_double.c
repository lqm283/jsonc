 ...
 * @LastEditTime : 2023-03-22 14:22:28
 * @LastEditors  : lqm283
 * --------------------------------------------------------------------------------<
 * @Description  : Please edit a descrition about this file at here.
 * --------------------------------------------------------------------------------<
 * @FilePath     : /jsonc/test/src/double/test_non_non_double.c
 */

#include <stdint.h>
#include <string.h>

#include "../../include/double/test_non_non_double.h"
/*
----------------------------------------------
复合类型转换为 json
----------------------------------------------
...
int test_change_non_non_single_double_num_to_json(char* exp, char* real) {
    int ret = 0;
    char* e = "{\"num\":10.147000}";
    struct TestNonNonSingleDoubleNum num;
    num.num = 10.147;
    ret = JsoncSerialize(real, &num, TestNonNonSingleDoubleNum);
    if (!ret) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_non_non_single_double_bool_to_json(char* exp, char* real) {
    int ret = 0;
    char* e = "{\"b\":true}";
    struct TestNonNonSingleDoubleBool b;
    b.b = 1;
    ret = JsoncSerialize(real, &b, TestNonNonSingleDoubleBool);
    if (!ret) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_non_non_mult_double_num_to_json(char* exp, char* real) {
    int ret = 0;
    char* e =
        "{\"num1\":-128.362000,\"num2\":-1.147000,\"num3\":0.000000,\"num4\":1.654000,"
        "\"num5\":127.125000}";
    struct TestNonNonMultDoubleNum num;
    num.num1 = -128.362;
    num.num2 = -1.147;
    num.num3 = 0;
    num.num4 = 1.654;
    num.num5 = 127.125;
    ret = JsoncSerialize(real, &num, TestNonNonMultDoubleNum);
    if (!ret) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_non_non_mult_double_bool_to_json(char* exp, char* real) {
    int ret = 0;
    char* e =
        "{\"bool1\":true,\"bool2\":true,\"bool3\":false,\"bool4\":true,\"bool5\":true}";
    struct TestNonNonMultDoubleBool bool;
    bool.bool1 = -128;
    bool.bool2 = -1;
    bool.bool3 = 0;
    bool.bool4 = 1;
    bool.bool5 = 127;
    ret = JsoncSerialize(real, &bool, TestNonNonMultDoubleBool);
    if (!ret) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_single_str_json_to_non_non_single_double_num(char* json) {
    int ret = 0;
    struct TestNonNonSingleDoubleNum num;
    ret = JsoncDeserialize(json, &num, TestNonNonSingleDoubleNum);
    if (ret) {
        return ret;
    }
    if (num.num != 10) {
...
int test_change_mult_str_json_to_non_non_single_double_num(char* json) {
    return test_change_single_str_json_to_non_non_single_double_num(json);
}
...
int test_change_mult_bool_json_to_non_non_single_double_num(char* json) {
    return test_change_single_bool_json_to_non_non_single_double_num(json);
}
...
int test_change_mult_null_json_to_non_non_single_double_num(char* json) {
    return test_change_single_null_json_to_non_non_single_double_num(json);
}
...
int test_change_single_str_json_to_non_non_single_double_bool(char* json) {
    int ret = 0;
    struct TestNonNonSingleDoubleBool b;
    ret = JsoncDeserialize(json, &b, TestNonNonSingleDoubleBool);
    if (ret) {
        return ret;
    }
    if (b.b != 1) {
...
int test_change_mult_str_json_to_non_non_single_double_bool(char* json) {
    return test_change_single_str_json_to_non_non_single_double_bool(json);
}
...
int test_change_mult_null_json_to_non_non_single_double_bool(char* json) {
    return test_change_single_null_json_to_non_non_single_double_bool(json);
}
...
int test_change_equal_mult_str_json_to_non_non_mult_double_num(char* json) {
    int ret = 0;
    struct TestNonNonMultDoubleNum num;
    ret = JsoncDeserialize(json, &num, TestNonNonMultDoubleNum);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_non_non_mult_double_num(char* json) {
    return test_change_equal_mult_str_json_to_non_non_mult_double_num(json);
}
...
int test_change_diff_mult_str_json_to_non_non_mult_double_num(char* json) {
    return test_change_less_mult_str_json_to_non_non_mult_double_num(json);
}
...
int test_change_more_mult_bool_json_to_non_non_mult_double_num(char* json) {
    return test_change_equal_mult_bool_json_to_non_non_mult_double_num(json);
}
...
int test_change_diff_mult_bool_json_to_non_non_mult_double_num(char* json) {
    return test_change_less_mult_bool_json_to_non_non_mult_double_num(json);
}
...
int test_change_more_mult_null_json_to_non_non_mult_double_num(char* json) {
    return test_change_equal_mult_null_json_to_non_non_mult_double_num(json);
}
...
int test_change_diff_mult_null_json_to_non_non_mult_double_num(char* json) {
    return test_change_less_mult_null_json_to_non_non_mult_double_num(json);
}
...
int test_change_equal_mult_str_json_to_non_non_mult_double_bool(char* json) {
    int ret = 0;
    struct TestNonNonMultDoubleBool bool;
    ret = JsoncDeserialize(json, &bool, TestNonNonMultDoubleBool);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_non_non_mult_double_bool(char* json) {
    return test_change_equal_mult_str_json_to_non_non_mult_double_bool(json);
}
...
int test_change_diff_mult_str_json_to_non_non_mult_double_bool(char* json) {
    return test_change_less_mult_str_json_to_non_non_mult_double_bool(json);
}
...
int test_change_more_mult_bool_json_to_non_non_mult_double_bool(char* json) {
    return test_change_equal_mult_bool_json_to_non_non_mult_double_bool(json);
}
...
int test_change_diff_mult_bool_json_to_non_non_mult_double_bool(char* json) {
    return test_change_less_mult_bool_json_to_non_non_mult_double_bool(json);
}
...
int test_change_more_mult_null_json_to_non_non_mult_double_bool(char* json) {
    return test_change_equal_mult_null_json_to_non_non_mult_double_bool(json);
}
...
int test_change_diff_mult_null_json_to_non_non_mult_double_bool(char* json) {
    return test_change_less_mult_null_json_to_non_non_mult_double_bool(json);
}
