 ...
 * @LastEditTime : 2023-01-11 14:13:59
 * @LastEditors  : lqm283
 * --------------------------------------------------------------------------------<
 * @Description  : Please edit a descrition about this file at here.
 * --------------------------------------------------------------------------------<
 * @FilePath     : /jsonc/test/src/double/test_non_arr_double.c
 */
...
#include "../../include/double/test_non_arr_double.h"
/*
----------------------------------------------
复合类型转换为 json
----------------------------------------------
...
char* test_change_non_arr_single_double_num_to_json(char* exp, char* real) {
    char* ret = 0;
...
char* test_change_non_arr_single_double_bool_to_json(char* exp, char* real) {
    char* ret = 0;
...
char* test_change_non_arr_mult_double_num_to_json(char* exp, char* real) {
    char* ret = 0;
    char* e =
    ...
    struct TestNonArrMultDoubleNum num = {{128.362, 255.147, 0, 1.654, 127.125},
...
char* test_change_non_arr_mult_double_bool_to_json(char* exp, char* real) {
    char* ret = 0;
    char* e =
    ...
    struct TestNonArrMultDoubleBool bool = {{128.362, 255.147, 0, 1.654, 127.125},
                                           {128.362, 255.147, 0, 1.654, 127.125},
                                           {128.362, 255.147, 0, 1.654, 127.125},
                                           {128.362, 255.147, 0, 1.654, 127.125},
                                           {128.362, 255.147, 0, 1.654, 127.125}};
...
int test_change_single_str_json_to_non_arr_single_double_num(char* json) {
    int ret = 0;
    struct TestNonArrSingleDoubleNum num;
    ret = JsoncDeserialize(json, &num, TestNonArrSingleDoubleNum);
    if (ret) {
        return ret;
    }
    if (*num.num != 10) {
...
int test_change_mult_str_json_to_non_arr_single_double_num(char* json) {
    return test_change_single_str_json_to_non_arr_single_double_num(json);
}
...
int test_change_mult_bool_json_to_non_arr_single_double_num(char* json) {
    return test_change_single_bool_json_to_non_arr_single_double_num(json);
}
...
int test_change_mult_null_json_to_non_arr_single_double_num(char* json) {
    return test_change_single_null_json_to_non_arr_single_double_num(json);
}

// 单元素 Str 类型的 json 转换为保存 Bool 类型的单成员 char
int test_change_single_str_json_to_non_arr_single_double_bool(char* json) {
    int ret = 0;
    struct TestNonArrSingleDoubleBool b;
    ret = JsoncDeserialize(json, &b, TestNonArrSingleDoubleBool);
    if (ret) {
        return ret;
    }
    if (*b.b != 1) {
...
int test_change_mult_str_json_to_non_arr_single_double_bool(char* json) {
    return test_change_single_str_json_to_non_arr_single_double_bool(json);
}
...
int test_change_mult_null_json_to_non_arr_single_double_bool(char* json) {
    return test_change_single_null_json_to_non_arr_single_double_bool(json);
}

// 完全匹配的多元素 Str 类型的 json 转换为保存 Num 类型的多成员 char
int test_change_equal_mult_str_json_to_non_arr_mult_double_num(char* json) {
    int ret = 0;
    struct TestNonArrMultDoubleNum num;
    ret = JsoncDeserialize(json, &num, TestNonArrMultDoubleNum);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_non_arr_mult_double_num(char* json) {
    return test_change_equal_mult_str_json_to_non_arr_mult_double_num(json);
}
...
int test_change_diff_mult_str_json_to_non_arr_mult_double_num(char* json) {
    return test_change_less_mult_str_json_to_non_arr_mult_double_num(json);
}
...
int test_change_more_mult_bool_json_to_non_arr_mult_double_num(char* json) {
    return test_change_equal_mult_bool_json_to_non_arr_mult_double_num(json);
}
...
int test_change_diff_mult_bool_json_to_non_arr_mult_double_num(char* json) {
    return test_change_less_mult_bool_json_to_non_arr_mult_double_num(json);
}
...
int test_change_more_mult_null_json_to_non_arr_mult_double_num(char* json) {
    return test_change_equal_mult_null_json_to_non_arr_mult_double_num(json);
}
...
int test_change_diff_mult_null_json_to_non_arr_mult_double_num(char* json) {
    return test_change_less_mult_null_json_to_non_arr_mult_double_num(json);
}

// 完全匹配的多元素 Str 类型的 json 转换为保存 Num 类型的多成员 char
int test_change_equal_mult_str_json_to_non_arr_mult_double_bool(char* json) {
    int ret = 0;
    struct TestNonArrMultDoubleBool bool;
    ret = JsoncDeserialize(json, &bool, TestNonArrMultDoubleBool);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_non_arr_mult_double_bool(char* json) {
    return test_change_equal_mult_str_json_to_non_arr_mult_double_bool(json);
}
...
int test_change_diff_mult_str_json_to_non_arr_mult_double_bool(char* json) {
    return test_change_less_mult_str_json_to_non_arr_mult_double_bool(json);
}
...
int test_change_more_mult_bool_json_to_non_arr_mult_double_bool(char* json) {
    return test_change_equal_mult_bool_json_to_non_arr_mult_double_bool(json);
}
...
int test_change_diff_mult_bool_json_to_non_arr_mult_double_bool(char* json) {
    return test_change_less_mult_bool_json_to_non_arr_mult_double_bool(json);
}
...
int test_change_more_mult_null_json_to_non_arr_mult_double_bool(char* json) {
    return test_change_equal_mult_null_json_to_non_arr_mult_double_bool(json);
}
...
int test_change_diff_mult_null_json_to_non_arr_mult_double_bool(char* json) {
    return test_change_less_mult_null_json_to_non_arr_mult_double_bool(json);
}
