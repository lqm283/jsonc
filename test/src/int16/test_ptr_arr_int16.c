 ...
 * --------------------------------------------------------------------------------<
 * @FilePath     : /jsonc/test/src/int16/test_ptr_arr_int16.c
 */

#include "../../include/int16/test_ptr_arr_int16.h"
...
int test_change_ptr_arr_single_int16_str_to_json(char* exp, char* real) {
    ...
    char* e =
        ...
        "to json\"]}";
    struct TestPtrArrSingleInt16Str str = {
...
int test_change_ptr_arr_mult_int16_str_to_json(char* exp, char* real) {
    ...
    char* e =
        ...
        "\"str3_0\",\"str3_1\"]}";
    struct TestPtrArrMultInt16Str str = {{(int16_t*)"str1_0", (int16_t*)"str1_1"},
...
int test_change_ptr_arr_mult_int16_bool_to_json(char* exp, char* real) {
    ...
    int16_t bool5 = 0;
    int16_t bool6 = 1;
    struct TestPtrArrMultInt16Bool bool = {{&bool1, &bool2},
                                           {&bool3, &bool4},
                                           {&bool5, &bool6}};
...
int test_change_single_str_json_to_ptr_arr_single_int16_num(char* json) {
    int ret = 0;
    struct TestPtrArrSingleInt16Num num;
    num.num[0] = malloc(sizeof(int16_t));
    num.num[1] = malloc(sizeof(int16_t));
    ret = JsoncDeserialize(json, &num, TestPtrArrSingleInt16Num);
    if (ret) {
        return ret;
    }
...
int test_change_mult_str_json_to_ptr_arr_single_int16_num(char* json) {
    return test_change_single_str_json_to_ptr_arr_single_int16_num(json);
}
...
int test_change_mult_bool_json_to_ptr_arr_single_int16_num(char* json) {
    return test_change_single_bool_json_to_ptr_arr_single_int16_num(json);
}
...
int test_change_mult_null_json_to_ptr_arr_single_int16_num(char* json) {
    return test_change_single_null_json_to_ptr_arr_single_int16_num(json);
}

// 单元素 Str 类型的 json 转换为保存 Bool 类型的指针数组单成员 char
int test_change_single_str_json_to_ptr_arr_single_int16_bool(char* json) {
    int ret = 0;
    struct TestPtrArrSingleInt16Bool b;
    b.b[0] = malloc(sizeof(int16_t));
    b.b[1] = malloc(sizeof(int16_t));
    ret = JsoncDeserialize(json, &b, TestPtrArrSingleInt16Bool);
    if (ret) {
        return ret;
    }
    if (*b.b[0] != 1 || *b.b[1] != 0) {
...
int test_change_mult_str_json_to_ptr_arr_single_int16_bool(char* json) {
    return test_change_single_str_json_to_ptr_arr_single_int16_bool(json);
}
...
int test_change_mult_null_json_to_ptr_arr_single_int16_bool(char* json) {
    return test_change_single_null_json_to_ptr_arr_single_int16_bool(json);
}

// 完全匹配的多元素 Str 类型的 json 转换为保存 Num 类型的指针数组多成员 char
int test_change_equal_mult_str_json_to_ptr_arr_mult_int16_num(char* json) {
    int ret = 0;
    struct TestPtrArrMultInt16Num num;
    num.num1[0] = malloc(sizeof(int16_t));
    num.num1[1] = malloc(sizeof(int16_t));
    num.num2[0] = malloc(sizeof(int16_t));
    num.num2[1] = malloc(sizeof(int16_t));
    num.num3[0] = malloc(sizeof(int16_t));
    num.num3[1] = malloc(sizeof(int16_t));
    ret = JsoncDeserialize(json, &num, TestPtrArrMultInt16Num);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_ptr_arr_mult_int16_num(char* json) {
    return test_change_equal_mult_str_json_to_ptr_arr_mult_int16_num(json);
}
...
int test_change_diff_mult_str_json_to_ptr_arr_mult_int16_num(char* json) {
    return test_change_less_mult_str_json_to_ptr_arr_mult_int16_num(json);
}
...
int test_change_more_mult_bool_json_to_ptr_arr_mult_int16_num(char* json) {
    return test_change_equal_mult_bool_json_to_ptr_arr_mult_int16_num(json);
}
...
int test_change_diff_mult_bool_json_to_ptr_arr_mult_int16_num(char* json) {
    return test_change_less_mult_bool_json_to_ptr_arr_mult_int16_num(json);
}
...
int test_change_more_mult_null_json_to_ptr_arr_mult_int16_num(char* json) {
    return test_change_equal_mult_null_json_to_ptr_arr_mult_int16_num(json);
}
...
int test_change_diff_mult_null_json_to_ptr_arr_mult_int16_num(char* json) {
    return test_change_less_mult_null_json_to_ptr_arr_mult_int16_num(json);
}

// 完全匹配的多元素 Str 类型的 json 转换为保存 Bool 类型的多成员 char
int test_change_equal_mult_str_json_to_ptr_arr_mult_int16_bool(char* json) {
    int ret = 0;
    struct TestPtrArrMultInt16Bool bool;
    bool.bool1[0] = malloc(sizeof(int16_t));
    bool.bool1[1] = malloc(sizeof(int16_t));
    bool.bool2[0] = malloc(sizeof(int16_t));
    bool.bool2[1] = malloc(sizeof(int16_t));
    bool.bool3[0] = malloc(sizeof(int16_t));
    bool.bool3[1] = malloc(sizeof(int16_t));
    ret = JsoncDeserialize(json, &bool, TestPtrArrMultInt16Bool);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_ptr_arr_mult_int16_bool(char* json) {
    return test_change_equal_mult_str_json_to_ptr_arr_mult_int16_bool(json);
}
...
int test_change_diff_mult_str_json_to_ptr_arr_mult_int16_bool(char* json) {
    return test_change_less_mult_str_json_to_ptr_arr_mult_int16_bool(json);
}
...
int test_change_more_mult_bool_json_to_ptr_arr_mult_int16_bool(char* json) {
    return test_change_equal_mult_bool_json_to_ptr_arr_mult_int16_bool(json);
}
...
int test_change_diff_mult_bool_json_to_ptr_arr_mult_int16_bool(char* json) {
    return test_change_less_mult_bool_json_to_ptr_arr_mult_int16_bool(json);
}
...
int test_change_more_mult_null_json_to_ptr_arr_mult_int16_bool(char* json) {
    return test_change_equal_mult_null_json_to_ptr_arr_mult_int16_bool(json);
}
...
int test_change_diff_mult_null_json_to_ptr_arr_mult_int16_bool(char* json) {
    return test_change_less_mult_null_json_to_ptr_arr_mult_int16_bool(json);
}
