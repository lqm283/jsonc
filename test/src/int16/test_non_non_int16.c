 ...
 * --------------------------------------------------------------------------------<
 * @FilePath     : /jsonc/test/src/int16/test_non_non_int16.c
 */

#include "../../include/int16/test_non_non_int16.h"
...
int test_change_single_str_json_to_non_non_single_int16_num(char* json) {
    int ret = 0;
    struct TestNonNonSingleInt16Num num;
    ret = JsoncDeserialize(json, &num, TestNonNonSingleInt16Num);
    if (ret) {
        return ret;
    }
    if (num.num != 10) {
...
int test_change_mult_str_json_to_non_non_single_int16_num(char* json) {
    return test_change_single_str_json_to_non_non_single_int16_num(json);
}
...
int test_change_mult_bool_json_to_non_non_single_int16_num(char* json) {
    return test_change_single_bool_json_to_non_non_single_int16_num(json);
}
...
int test_change_mult_null_json_to_non_non_single_int16_num(char* json) {
    return test_change_single_null_json_to_non_non_single_int16_num(json);
}
...
int test_change_single_str_json_to_non_non_single_int16_bool(char* json) {
    int ret = 0;
    struct TestNonNonSingleInt16Bool b;
    ret = JsoncDeserialize(json, &b, TestNonNonSingleInt16Bool);
    if (ret) {
        return ret;
    }
    if (b.b != 1) {
...
int test_change_mult_str_json_to_non_non_single_int16_bool(char* json) {
    return test_change_single_str_json_to_non_non_single_int16_bool(json);
}
...
int test_change_mult_null_json_to_non_non_single_int16_bool(char* json) {
    return test_change_single_null_json_to_non_non_single_int16_bool(json);
}
...
int test_change_equal_mult_str_json_to_non_non_mult_int16_num(char* json) {
    int ret = 0;
    struct TestNonNonMultInt16Num num;
    ret = JsoncDeserialize(json, &num, TestNonNonMultInt16Num);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_non_non_mult_int16_num(char* json) {
    return test_change_equal_mult_str_json_to_non_non_mult_int16_num(json);
}
...
int test_change_diff_mult_str_json_to_non_non_mult_int16_num(char* json) {
    return test_change_less_mult_str_json_to_non_non_mult_int16_num(json);
}
...
int test_change_more_mult_bool_json_to_non_non_mult_int16_num(char* json) {
    return test_change_equal_mult_bool_json_to_non_non_mult_int16_num(json);
}
...
int test_change_diff_mult_bool_json_to_non_non_mult_int16_num(char* json) {
    return test_change_less_mult_bool_json_to_non_non_mult_int16_num(json);
}
...
int test_change_more_mult_null_json_to_non_non_mult_int16_num(char* json) {
    return test_change_equal_mult_null_json_to_non_non_mult_int16_num(json);
}
...
int test_change_diff_mult_null_json_to_non_non_mult_int16_num(char* json) {
    return test_change_less_mult_null_json_to_non_non_mult_int16_num(json);
}
...
int test_change_equal_mult_str_json_to_non_non_mult_int16_bool(char* json) {
    int ret = 0;
    struct TestNonNonMultInt16Bool bool;
    ret = JsoncDeserialize(json, &bool, TestNonNonMultInt16Bool);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_non_non_mult_int16_bool(char* json) {
    return test_change_equal_mult_str_json_to_non_non_mult_int16_bool(json);
}
...
int test_change_diff_mult_str_json_to_non_non_mult_int16_bool(char* json) {
    return test_change_less_mult_str_json_to_non_non_mult_int16_bool(json);
}
...
int test_change_more_mult_bool_json_to_non_non_mult_int16_bool(char* json) {
    return test_change_equal_mult_bool_json_to_non_non_mult_int16_bool(json);
}
...
int test_change_diff_mult_bool_json_to_non_non_mult_int16_bool(char* json) {
    return test_change_less_mult_bool_json_to_non_non_mult_int16_bool(json);
}
...
int test_change_more_mult_null_json_to_non_non_mult_int16_bool(char* json) {
    return test_change_equal_mult_null_json_to_non_non_mult_int16_bool(json);
}
...
int test_change_diff_mult_null_json_to_non_non_mult_int16_bool(char* json) {
    return test_change_less_mult_null_json_to_non_non_mult_int16_bool(json);
}
