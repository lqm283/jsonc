 ...
 * @LastEditTime : 2023-01-11 10:49:55
 * @LastEditors  : lqm283
 * --------------------------------------------------------------------------------<
...
char* test_change_ptr_arr_single_int64_str_to_json(char* exp, char* real) {
    char* ret = 0;
    char* e =
...
char* test_change_ptr_arr_single_int64_num_to_json(char* exp, char* real) {
    char* ret = 0;
    char* e = "{\"num\":[10,20]}";
...
char* test_change_ptr_arr_single_int64_bool_to_json(char* exp, char* real) {
    char* ret = 0;
    char* e = "{\"b\":[true,false]}";
    int64_t bool1 = 1;
    int64_t bool2 = 0;
...
char* test_change_ptr_arr_mult_int64_str_to_json(char* exp, char* real) {
    char* ret = 0;
    char* e =
...
char* test_change_ptr_arr_mult_int64_num_to_json(char* exp, char* real) {
    char* ret = 0;
...
char* test_change_ptr_arr_mult_int64_bool_to_json(char* exp, char* real) {
    char* ret = 0;
