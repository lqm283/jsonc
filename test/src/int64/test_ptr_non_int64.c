 ...
 * @LastEditTime : 2023-03-22 13:58:43
 * @LastEditors  : lqm283
 * --------------------------------------------------------------------------------<
 * @Description  : Please edit a descrition about this file at here.
 * --------------------------------------------------------------------------------<
 * @FilePath     : /jsonc/test/src/int64/test_ptr_non_int64.c
 */

#include "../../include/int64/test_ptr_non_int64.h"
...
int test_change_ptr_non_single_int64_str_to_json(char* exp, char* real) {
    int ret = 0;
    char* e = "{\"str\":\"test change char * str to json\"}";
    int64_t* s = (int64_t*)"test change char * str to json";
    struct TestPtrNonSingleInt64Str str;
    str.str = s;
    ret = JsoncSerialize(real, &str, TestPtrNonSingleInt64Str);
    if (ret > 0) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_ptr_non_single_int64_num_to_json(char* exp, char* real) {
    int ret = 0;
    char* e = "{\"num\":10}";
    struct TestPtrNonSingleInt64Num num;
    num.num = malloc(sizeof(int64_t));
    *num.num = 10;
    ret = JsoncSerialize(real, &num, TestPtrNonSingleInt64Num);
    if (ret > 0) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_ptr_non_single_int64_bool_to_json(char* exp, char* real) {
    int ret = 0;
    char* e = "{\"b\":true}";
    struct TestPtrNonSingleInt64Bool b;
    b.b = malloc(sizeof(int64_t));
    *b.b = 1;
    ret = JsoncSerialize(real, &b, TestPtrNonSingleInt64Bool);
    if (ret > 0) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_ptr_non_mult_int64_str_to_json(char* exp, char* real) {
    int ret = 0;
    char* e = "{\"str1\":\"I am str1\",\"str2\":\"I am str2\",\"str3\":\"c\"}";
    struct TestPtrNonMultInt64Str str;
    str.str3 = malloc(sizeof(int64_t));
    str.str1 = (int64_t*)"I am str1";
    str.str2 = (int64_t*)"I am str2";
    *str.str3 = 'c';
    ret = JsoncSerialize(real, &str, TestPtrNonMultInt64Str);
    if (ret > 0) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_ptr_non_mult_int64_num_to_json(char* exp, char* real) {
    int ret = 0;
    char* e = "{\"num1\":-128,\"num2\":-1,\"num3\":0,\"num4\":1,\"num5\":127}";
    struct TestPtrNonMultInt64Num num;
    num.num1 = malloc(sizeof(int64_t));
    num.num2 = malloc(sizeof(int64_t));
    num.num3 = malloc(sizeof(int64_t));
    num.num4 = malloc(sizeof(int64_t));
    num.num5 = malloc(sizeof(int64_t));
    *num.num1 = -128;
    *num.num2 = -1;
    *num.num3 = 0;
    *num.num4 = 1;
    *num.num5 = 127;
    ret = JsoncSerialize(real, &num, TestPtrNonMultInt64Num);
    if (ret > 0) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_ptr_non_mult_int64_bool_to_json(char* exp, char* real) {
    int ret = 0;
    char* e =
        "{\"bool1\":true,\"bool2\":true,\"bool3\":false,\"bool4\":true,\"bool5\":true}";
    struct TestPtrNonMultInt64Bool bool;
    bool.bool1 = malloc(sizeof(int64_t));
    bool.bool2 = malloc(sizeof(int64_t));
    bool.bool3 = malloc(sizeof(int64_t));
    bool.bool4 = malloc(sizeof(int64_t));
    bool.bool5 = malloc(sizeof(int64_t));
    *bool.bool1 = -128;
    *bool.bool2 = -1;
    *bool.bool3 = 0;
    *bool.bool4 = 1;
    *bool.bool5 = 127;
    ret = JsoncSerialize(real, &bool, TestPtrNonMultInt64Bool);
    if (ret > 0) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_single_str_json_to_ptr_non_single_int64_num(char* json) {
    ...
    struct TestPtrNonSingleInt64Num num;
    num.num = malloc(sizeof(int64_t));
    ret = JsoncDeserialize(json, &num, TestPtrNonSingleInt64Num);
    if (ret) {
        return ret;
    }
    if (*num.num != 10) {
...
int test_change_mult_str_json_to_ptr_non_single_int64_num(char* json) {
    return test_change_single_str_json_to_ptr_non_single_int64_num(json);
}
...
int test_change_mult_bool_json_to_ptr_non_single_int64_num(char* json) {
    return test_change_single_bool_json_to_ptr_non_single_int64_num(json);
}
...
int test_change_mult_null_json_to_ptr_non_single_int64_num(char* json) {
    return test_change_single_null_json_to_ptr_non_single_int64_num(json);
}
...
int test_change_single_str_json_to_ptr_non_single_int64_bool(char* json) {
    ...
    struct TestPtrNonSingleInt64Bool b;
    b.b = malloc(sizeof(int64_t));
    ret = JsoncDeserialize(json, &b, TestPtrNonSingleInt64Bool);
    if (ret) {
        return ret;
    }
    if (*b.b != 1) {
...
int test_change_mult_str_json_to_ptr_non_single_int64_bool(char* json) {
    return test_change_single_str_json_to_ptr_non_single_int64_bool(json);
}
...
int test_change_mult_null_json_to_ptr_non_single_int64_bool(char* json) {
    return test_change_single_null_json_to_ptr_non_single_int64_bool(json);
}
...
int test_change_equal_mult_str_json_to_ptr_non_mult_int64_num(char* json) {
    ...
    num.num4 = malloc(sizeof(int64_t));
    num.num5 = malloc(sizeof(int64_t));
    ret = JsoncDeserialize(json, &num, TestPtrNonMultInt64Num);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_ptr_non_mult_int64_num(char* json) {
    return test_change_equal_mult_str_json_to_ptr_non_mult_int64_num(json);
}
...
int test_change_diff_mult_str_json_to_ptr_non_mult_int64_num(char* json) {
    return test_change_less_mult_str_json_to_ptr_non_mult_int64_num(json);
}
...
int test_change_more_mult_bool_json_to_ptr_non_mult_int64_num(char* json) {
    return test_change_equal_mult_bool_json_to_ptr_non_mult_int64_num(json);
}
...
int test_change_diff_mult_bool_json_to_ptr_non_mult_int64_num(char* json) {
    return test_change_less_mult_bool_json_to_ptr_non_mult_int64_num(json);
}
...
int test_change_more_mult_null_json_to_ptr_non_mult_int64_num(char* json) {
    return test_change_equal_mult_null_json_to_ptr_non_mult_int64_num(json);
}
...
int test_change_diff_mult_null_json_to_ptr_non_mult_int64_num(char* json) {
    return test_change_less_mult_null_json_to_ptr_non_mult_int64_num(json);
}
...
int test_change_equal_mult_str_json_to_ptr_non_mult_int64_bool(char* json) {
    ...
    bool.bool4 = malloc(sizeof(int64_t));
    bool.bool5 = malloc(sizeof(int64_t));
    ret = JsoncDeserialize(json, &bool, TestPtrNonMultInt64Bool);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_ptr_non_mult_int64_bool(char* json) {
    return test_change_equal_mult_str_json_to_ptr_non_mult_int64_bool(json);
}
...
int test_change_diff_mult_str_json_to_ptr_non_mult_int64_bool(char* json) {
    return test_change_less_mult_str_json_to_ptr_non_mult_int64_bool(json);
}
...
int test_change_more_mult_bool_json_to_ptr_non_mult_int64_bool(char* json) {
    return test_change_equal_mult_bool_json_to_ptr_non_mult_int64_bool(json);
}
...
int test_change_diff_mult_bool_json_to_ptr_non_mult_int64_bool(char* json) {
    return test_change_less_mult_bool_json_to_ptr_non_mult_int64_bool(json);
}
...
int test_change_more_mult_null_json_to_ptr_non_mult_int64_bool(char* json) {
    return test_change_equal_mult_null_json_to_ptr_non_mult_int64_bool(json);
}
...
int test_change_diff_mult_null_json_to_ptr_non_mult_int64_bool(char* json) {
    return test_change_less_mult_null_json_to_ptr_non_mult_int64_bool(json);
}
