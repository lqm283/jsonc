 ...
 * @LastEditTime : 2023-03-22 13:53:36
 * @LastEditors  : lqm283
 * --------------------------------------------------------------------------------<
 * @Description  : Please edit a descrition about this file at here.
 * --------------------------------------------------------------------------------<
 * @FilePath     : /jsonc/test/src/int32/test_non_arr_int32.c
 */

#include "../../include/int32/test_non_arr_int32.h"
...
int test_change_non_arr_single_int32_num_to_json(char* exp, char* real) {
    int ret = 0;
    char* e = "{\"num\":[1,2,3,4,5]}";
    struct TestNonArrSingleInt32Num num = {{1, 2, 3, 4, 5}};
    ret = JsoncSerialize(real, &num, TestNonArrSingleInt32Num);
    if (ret > 0) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_non_arr_single_int32_bool_to_json(char* exp, char* real) {
    int ret = 0;
    char* e = "{\"b\":[true,false,true,true,false]}";
    struct TestNonArrSingleInt32Bool b = {{1, 0, 1, 1, 0}};
    ret = JsoncSerialize(real, &b, TestNonArrSingleInt32Bool);
    if (ret > 0) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_non_arr_mult_int32_num_to_json(char* exp, char* real) {
    int ret = 0;
    char* e =
        "{\"num1\":[128,255,0,1,127],\"num2\":[128,255,0,1,127],\"num3\":[128,255,0,1,"
        "127],\"num4\":[128,255,0,1,127],\"num5\":[128,255,0,1,127]}";
    struct TestNonArrMultInt32Num num = {{128, 255, 0, 1, 127},
                                         {128, 255, 0, 1, 127},
                                         {128, 255, 0, 1, 127},
                                         {128, 255, 0, 1, 127},
                                         {128, 255, 0, 1, 127}};
    ret = JsoncSerialize(real, &num, TestNonArrMultInt32Num);
    if (ret > 0) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_non_arr_mult_int32_bool_to_json(char* exp, char* real) {
    int ret = 0;
    char* e =
    ...
    struct TestNonArrMultInt32Bool bool = {{128, 255, 0, 1, 127},
                                           {128, 255, 0, 1, 127},
                                           {128, 255, 0, 1, 127},
                                           {128, 255, 0, 1, 127},
                                           {128, 255, 0, 1, 127}};
    ret = JsoncSerialize(real, &bool, TestNonArrMultInt32Bool);
    if (ret > 0) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_single_str_json_to_non_arr_single_int32_num(char* json) {
    int ret = 0;
    struct TestNonArrSingleInt32Num num;
    ret = JsoncDeserialize(json, &num, TestNonArrSingleInt32Num);
    if (ret) {
        return ret;
    }
    if (*num.num != 10) {
...
int test_change_mult_str_json_to_non_arr_single_int32_num(char* json) {
    return test_change_single_str_json_to_non_arr_single_int32_num(json);
}
...
int test_change_mult_bool_json_to_non_arr_single_int32_num(char* json) {
    return test_change_single_bool_json_to_non_arr_single_int32_num(json);
}
...
int test_change_mult_null_json_to_non_arr_single_int32_num(char* json) {
    return test_change_single_null_json_to_non_arr_single_int32_num(json);
}

// 单元素 Str 类型的 json 转换为保存 Bool 类型的单成员 char
int test_change_single_str_json_to_non_arr_single_int32_bool(char* json) {
    int ret = 0;
    struct TestNonArrSingleInt32Bool b;
    ret = JsoncDeserialize(json, &b, TestNonArrSingleInt32Bool);
    if (ret) {
        return ret;
    }
    if (*b.b != 1) {
...
int test_change_mult_str_json_to_non_arr_single_int32_bool(char* json) {
    return test_change_single_str_json_to_non_arr_single_int32_bool(json);
}
...
int test_change_mult_null_json_to_non_arr_single_int32_bool(char* json) {
    return test_change_single_null_json_to_non_arr_single_int32_bool(json);
}

// 完全匹配的多元素 Str 类型的 json 转换为保存 Num 类型的多成员 char
int test_change_equal_mult_str_json_to_non_arr_mult_int32_num(char* json) {
    int ret = 0;
    struct TestNonArrMultInt32Num num;
    ret = JsoncDeserialize(json, &num, TestNonArrMultInt32Num);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_non_arr_mult_int32_num(char* json) {
    return test_change_equal_mult_str_json_to_non_arr_mult_int32_num(json);
}
...
int test_change_diff_mult_str_json_to_non_arr_mult_int32_num(char* json) {
    return test_change_less_mult_str_json_to_non_arr_mult_int32_num(json);
}
...
int test_change_more_mult_bool_json_to_non_arr_mult_int32_num(char* json) {
    return test_change_equal_mult_bool_json_to_non_arr_mult_int32_num(json);
}
...
int test_change_diff_mult_bool_json_to_non_arr_mult_int32_num(char* json) {
    return test_change_less_mult_bool_json_to_non_arr_mult_int32_num(json);
}
...
int test_change_more_mult_null_json_to_non_arr_mult_int32_num(char* json) {
    return test_change_equal_mult_null_json_to_non_arr_mult_int32_num(json);
}
...
int test_change_diff_mult_null_json_to_non_arr_mult_int32_num(char* json) {
    return test_change_less_mult_null_json_to_non_arr_mult_int32_num(json);
}

// 完全匹配的多元素 Str 类型的 json 转换为保存 Num 类型的多成员 char
int test_change_equal_mult_str_json_to_non_arr_mult_int32_bool(char* json) {
    int ret = 0;
    struct TestNonArrMultInt32Bool bool;
    ret = JsoncDeserialize(json, &bool, TestNonArrMultInt32Bool);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_non_arr_mult_int32_bool(char* json) {
    return test_change_equal_mult_str_json_to_non_arr_mult_int32_bool(json);
}
...
int test_change_diff_mult_str_json_to_non_arr_mult_int32_bool(char* json) {
    return test_change_less_mult_str_json_to_non_arr_mult_int32_bool(json);
}
...
int test_change_more_mult_bool_json_to_non_arr_mult_int32_bool(char* json) {
    return test_change_equal_mult_bool_json_to_non_arr_mult_int32_bool(json);
}
...
int test_change_diff_mult_bool_json_to_non_arr_mult_int32_bool(char* json) {
    return test_change_less_mult_bool_json_to_non_arr_mult_int32_bool(json);
}
...
int test_change_more_mult_null_json_to_non_arr_mult_int32_bool(char* json) {
    return test_change_equal_mult_null_json_to_non_arr_mult_int32_bool(json);
}
...
int test_change_diff_mult_null_json_to_non_arr_mult_int32_bool(char* json) {
    return test_change_less_mult_null_json_to_non_arr_mult_int32_bool(json);
}
