 ...
 * @LastEditTime : 2023-03-22 13:55:07
 * @LastEditors  : lqm283
 * --------------------------------------------------------------------------------<
 * @Description  : Please edit a descrition about this file at here.
 * --------------------------------------------------------------------------------<
 * @FilePath     : /jsonc/test/src/int32/test_ptr_arr_int32.c
 */

#include "../../include/int32/test_ptr_arr_int32.h"
...
int test_change_ptr_arr_single_int32_str_to_json(char* exp, char* real) {
    ...
    char* e =
        ...
        "to json\"]}";
    struct TestPtrArrSingleInt32Str str = {
        {(int32_t*)"test change char * [0] str to json",
         (int32_t*)"test change char * [1] str to json"}};
    ret = JsoncSerialize(real, &str, TestPtrArrSingleInt32Str);
    if (!ret) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_ptr_arr_single_int32_num_to_json(char* exp, char* real) {
    int ret = 0;
    char* e = "{\"num\":[10,20]}";
    struct TestPtrArrSingleInt32Num num;
    int32_t num1 = 10;
    num.num[0] = &num1;
    num.num[1] = malloc(1);
    *num.num[1] = 20;
    ret = JsoncSerialize(real, &num, TestPtrArrSingleInt32Num);
    if (!ret) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_ptr_arr_single_int32_bool_to_json(char* exp, char* real) {
    ...
    int32_t bool1 = 1;
    int32_t bool2 = 0;
    struct TestPtrArrSingleInt32Bool b = {{&bool1, &bool2}};
    ret = JsoncSerialize(real, &b, TestPtrArrSingleInt32Bool);
    if (!ret) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_ptr_arr_mult_int32_str_to_json(char* exp, char* real) {
    ...
    char* e =
        ...
        "\"str3_0\",\"str3_1\"]}";
    struct TestPtrArrMultInt32Str str = {{(int32_t*)"str1_0", (int32_t*)"str1_1"},
                                         {(int32_t*)"str2_0", (int32_t*)"str2_1"},
                                         {(int32_t*)"str3_0", (int32_t*)"str3_1"}};
    ret = JsoncSerialize(real, &str, TestPtrArrMultInt32Str);
    if (!ret) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_ptr_arr_mult_int32_num_to_json(char* exp, char* real) {
    ...
    struct TestPtrArrMultInt32Num num = {{&num1, &num2}, {&num3, &num4}, {&num5, &num6}};
    ret = JsoncSerialize(real, &num, TestPtrArrMultInt32Num);
    if (!ret) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_ptr_arr_mult_int32_bool_to_json(char* exp, char* real) {
    ...
    int32_t bool5 = 0;
    int32_t bool6 = 1;
    struct TestPtrArrMultInt32Bool bool = {{&bool1, &bool2},
                                           {&bool3, &bool4},
                                           {&bool5, &bool6}};
    ret = JsoncSerialize(real, &bool, TestPtrArrMultInt32Bool);
    if (!ret) {
        strcpy(exp, e);
    }
    return ret;
...
int test_change_single_str_json_to_ptr_arr_single_int32_num(char* json) {
    int ret = 0;
    struct TestPtrArrSingleInt32Num num;
    num.num[0] = malloc(sizeof(int32_t));
    num.num[1] = malloc(sizeof(int32_t));
    ret = JsoncDeserialize(json, &num, TestPtrArrSingleInt32Num);
    if (ret) {
        return ret;
    }
...
int test_change_mult_str_json_to_ptr_arr_single_int32_num(char* json) {
    return test_change_single_str_json_to_ptr_arr_single_int32_num(json);
}
...
int test_change_mult_bool_json_to_ptr_arr_single_int32_num(char* json) {
    return test_change_single_bool_json_to_ptr_arr_single_int32_num(json);
}
...
int test_change_mult_null_json_to_ptr_arr_single_int32_num(char* json) {
    return test_change_single_null_json_to_ptr_arr_single_int32_num(json);
}

// 单元素 Str 类型的 json 转换为保存 Bool 类型的指针数组单成员 char
int test_change_single_str_json_to_ptr_arr_single_int32_bool(char* json) {
    int ret = 0;
    struct TestPtrArrSingleInt32Bool b;
    b.b[0] = malloc(sizeof(int32_t));
    b.b[1] = malloc(sizeof(int32_t));
    ret = JsoncDeserialize(json, &b, TestPtrArrSingleInt32Bool);
    if (ret) {
        return ret;
    }
    if (*b.b[0] != 1 || *b.b[1] != 0) {
...
int test_change_mult_str_json_to_ptr_arr_single_int32_bool(char* json) {
    return test_change_single_str_json_to_ptr_arr_single_int32_bool(json);
}
...
int test_change_mult_null_json_to_ptr_arr_single_int32_bool(char* json) {
    return test_change_single_null_json_to_ptr_arr_single_int32_bool(json);
}

// 完全匹配的多元素 Str 类型的 json 转换为保存 Num 类型的指针数组多成员 char
int test_change_equal_mult_str_json_to_ptr_arr_mult_int32_num(char* json) {
    int ret = 0;
    struct TestPtrArrMultInt32Num num;
    num.num1[0] = malloc(sizeof(int32_t));
    num.num1[1] = malloc(sizeof(int32_t));
    num.num2[0] = malloc(sizeof(int32_t));
    num.num2[1] = malloc(sizeof(int32_t));
    num.num3[0] = malloc(sizeof(int32_t));
    num.num3[1] = malloc(sizeof(int32_t));
    ret = JsoncDeserialize(json, &num, TestPtrArrMultInt32Num);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_ptr_arr_mult_int32_num(char* json) {
    return test_change_equal_mult_str_json_to_ptr_arr_mult_int32_num(json);
}
...
int test_change_diff_mult_str_json_to_ptr_arr_mult_int32_num(char* json) {
    return test_change_less_mult_str_json_to_ptr_arr_mult_int32_num(json);
}
...
int test_change_more_mult_bool_json_to_ptr_arr_mult_int32_num(char* json) {
    return test_change_equal_mult_bool_json_to_ptr_arr_mult_int32_num(json);
}
...
int test_change_diff_mult_bool_json_to_ptr_arr_mult_int32_num(char* json) {
    return test_change_less_mult_bool_json_to_ptr_arr_mult_int32_num(json);
}
...
int test_change_more_mult_null_json_to_ptr_arr_mult_int32_num(char* json) {
    return test_change_equal_mult_null_json_to_ptr_arr_mult_int32_num(json);
}
...
int test_change_diff_mult_null_json_to_ptr_arr_mult_int32_num(char* json) {
    return test_change_less_mult_null_json_to_ptr_arr_mult_int32_num(json);
}

// 完全匹配的多元素 Str 类型的 json 转换为保存 Bool 类型的多成员 char
int test_change_equal_mult_str_json_to_ptr_arr_mult_int32_bool(char* json) {
    int ret = 0;
    struct TestPtrArrMultInt32Bool bool;
    bool.bool1[0] = malloc(sizeof(int32_t));
    bool.bool1[1] = malloc(sizeof(int32_t));
    bool.bool2[0] = malloc(sizeof(int32_t));
    bool.bool2[1] = malloc(sizeof(int32_t));
    bool.bool3[0] = malloc(sizeof(int32_t));
    bool.bool3[1] = malloc(sizeof(int32_t));
    ret = JsoncDeserialize(json, &bool, TestPtrArrMultInt32Bool);
    if (ret) {
        return ret;
    }
...
int test_change_more_mult_str_json_to_ptr_arr_mult_int32_bool(char* json) {
    return test_change_equal_mult_str_json_to_ptr_arr_mult_int32_bool(json);
}
...
int test_change_diff_mult_str_json_to_ptr_arr_mult_int32_bool(char* json) {
    return test_change_less_mult_str_json_to_ptr_arr_mult_int32_bool(json);
}
...
int test_change_more_mult_bool_json_to_ptr_arr_mult_int32_bool(char* json) {
    return test_change_equal_mult_bool_json_to_ptr_arr_mult_int32_bool(json);
}
...
int test_change_diff_mult_bool_json_to_ptr_arr_mult_int32_bool(char* json) {
    return test_change_less_mult_bool_json_to_ptr_arr_mult_int32_bool(json);
}
...
int test_change_more_mult_null_json_to_ptr_arr_mult_int32_bool(char* json) {
    return test_change_equal_mult_null_json_to_ptr_arr_mult_int32_bool(json);
}
...
int test_change_diff_mult_null_json_to_ptr_arr_mult_int32_bool(char* json) {
    return test_change_less_mult_null_json_to_ptr_arr_mult_int32_bool(json);
}
