 ...
 * @LastEditTime : 2022-06-09 15:36:59
...
char p_char_str_base_arr[2][100] = {"p_char_str_base_arr[0]",
                                    "p_char_str_base_arr[1]"};
char p_char_num_base_arr[2] = {-50, -51};
char p_char_bool_base_arr[2] = {True, False};
uint8_t p_uchar_str_base_arr[2][100] = {"p_uchar_str_base_arr[0]",
                                        "p_uchar_str_base_arr[1]"};
...
int struct_to_json_test(void) {
  ...
  struct test1 struct_to_json_base_test = {
      ...
      .p_char_bool_base_arr = {&p_char_bool_base_arr[0],
                               &p_char_bool_base_arr[1]},
      .p_uchar_str_base_arr = {p_uchar_str_base_arr[0],
                               p_uchar_str_base_arr[1]},
      .p_uchar_num_base_arr = {&p_uchar_num_base_arr[0],
                               &p_uchar_num_base_arr[1]},
      .p_uchar_bool_base_arr = {&p_uchar_bool_base_arr[0],
                                &p_uchar_bool_base_arr[1]},
      .p_short_num_base_arr = {&p_short_num_base_arr[0],
                               &p_short_num_base_arr[1]},
      .p_short_bool_base_arr = {&p_short_bool_base_arr[0],
                                &p_short_bool_base_arr[1]},
      .p_ushort_num_base_arr = {&p_ushort_num_base_arr[0],
                                &p_ushort_num_base_arr[1]},
      .p_ushort_bool_base_arr = {&p_ushort_bool_base_arr[0],
                                 &p_ushort_bool_base_arr[1]},
      ...
      .p_uint_bool_base_arr = {&p_uint_bool_base_arr[0],
                               &p_uint_bool_base_arr[1]},
      ...
      .p_float_num_base_arr = {&p_float_num_base_arr[0],
                               &p_float_num_base_arr[1]},
      .p_float_bool_base_arr = {&p_float_bool_base_arr[0],
                                &p_float_bool_base_arr[1]},
      .p_double_num_base_arr = {&p_double_num_base_arr[0],
                                &p_double_num_base_arr[1]},
      .p_double_bool_base_arr = {&p_double_bool_base_arr[0],
                                 &p_double_bool_base_arr[1]},
  };
  jsonc_serialize(buf, &struct_to_json_base_test, STRUCT(test1));
  printf("%s\n", buf);
  ...
  test2 struct_to_json_nult_test =
      {
          .normal_val =
              {
                  ...
                  .p_double_bool_base = &p_double_bool_base,
                  //指针数组
                  .p_char_str_base_arr = {p_char_str_base_arr[0],
                                          p_char_str_base_arr[1]},
                  .p_char_num_base_arr = {&p_char_num_base_arr[0],
                                          &p_char_num_base_arr[1]},
                  .p_char_bool_base_arr = {&p_char_bool_base_arr[0],
                                           &p_char_bool_base_arr[1]},
                  .p_uchar_str_base_arr = {p_uchar_str_base_arr[0],
                                           p_uchar_str_base_arr[1]},
                  ...
                  .p_ushort_bool_base_arr = {&p_ushort_bool_base_arr[0],
                                             &p_ushort_bool_base_arr[1]},
                  .p_int_num_base_arr = {&p_int_num_base_arr[0],
                                         &p_int_num_base_arr[1]},
                  .p_int_bool_base_arr = {&p_int_bool_base_arr[0],
                                          &p_int_bool_base_arr[1]},
                  .p_uint_num_base_arr = {&p_uint_num_base_arr[0],
                                          &p_uint_num_base_arr[1]},
                  .p_uint_bool_base_arr = {&p_uint_bool_base_arr[0],
                                           &p_uint_bool_base_arr[1]},
                  .p_ll_num_base_arr = {&p_ll_num_base_arr[0],
                                        &p_ll_num_base_arr[1]},
                  .p_ll_bool_base_arr = {&p_ll_bool_base_arr[0],
                                         &p_ll_bool_base_arr[1]},
                  .p_ull_num_base_arr = {&p_ull_num_base_arr[0],
                                         &p_ull_num_base_arr[1]},
                  .p_ull_bool_base_arr = {&p_ull_bool_base_arr[0],
                                          &p_ull_bool_base_arr[1]},
                  .p_float_num_base_arr = {&p_float_num_base_arr[0],
                                           &p_float_num_base_arr[1]},
                  .p_float_bool_base_arr = {&p_float_bool_base_arr[0],
                                            &p_float_bool_base_arr[1]},
          ...
          .ptr_arr_val = {&struct_to_json_base_test,
                          &struct_to_json_base_test}};

  jsonc_serialize(buf, &struct_to_json_nult_test, STRUCT(test2));
  printf("%s\n", buf);
