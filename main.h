 ...
 * @LastEditTime : 2022-06-16 15:07:21
...
INIT(un,
     ...
     MEM(struct un, Bool, char, char_null, NULL),
     ...
     MEM(struct un, Bool, uint8_t *, p_uchar_null, NULL),
     ...
     MEM(struct un, Bool, short *, p_short_null, NULL),
     ...
     MEM(struct un, Bool, unsigned int *, p_uint_null, NULL),
     ...
     MEM(struct un, Bool, long long *, p_ll_null, NULL),
     ...
     MEM(struct un, Bool, unsigned long long *, p_ull_null, NULL),
     ...
     MEM(struct un, Bool, float *, p_float_null, NULL),
     ...
     MEM(struct un, Bool, double *, p_double_null, NULL),
     // 数组
     ...
     MEM(struct un, Bool, char, arr_char_null, NULL),
     ...
     MEM(struct un, Bool, uint8_t, arr_uchar_null, NULL),
     ...
     MEM(struct un, Bool, short, arr_short_null, NULL),
     ...
     MEM(struct un, Bool, unsigned int, arr_uint_null, NULL),
     ...
     MEM(struct un, Bool, long long, arr_ll_null, NULL),
     ...
     MEM(struct un, Bool, unsigned long long, arr_ull_null, NULL),
     ...
     MEM(struct un, Bool, float, arr_float_null, NULL),
     ...
     MEM(struct un, Bool, double, arr_double_null, NULL),
     // 指针数组
     ...
     MEM(struct un, Bool, char *, p_arr_char_null, NULL),
     ...
     MEM(struct un, Bool, uint8_t *, p_arr_uchar_null, NULL),
     ...
     MEM(struct un, Bool, short *, p_arr_short_null, NULL),
     ...
     MEM(struct un, Bool, unsigned short *, p_arr_ushort_null, NULL),
     ...
     MEM(struct un, Bool, int *, p_arr_int_null, NULL),
     ...
     MEM(struct un, Bool, unsigned int *, p_arr_uint_null, NULL),
     ...
     MEM(struct un, Bool, long long *, p_arr_ll_null, NULL),
     ...
     MEM(struct un, Bool, unsigned long long *, p_arr_ull_null, NULL),
     ...
     MEM(struct un, Bool, float *, p_arr_float_null, NULL),
     ...
     MEM(struct un, Bool, double *, p_arr_double_null, NULL));
...
struct test {
    ...
    struct un *p_arr_test_un_null[2];
};
INIT(test,
     struct test,
     ...
     MEM(struct test, Str, struct un *, p_test_un_null, un),
     MEM(struct test, Num, struct un, arr_test_un, un),
     MEM(struct test, Bool, struct un *, p_arr_test_un, un),
     MEM(struct test, Bool, struct un *, p_arr_test_un_null, un));
